                    ...
                    <div class="col-12 col-sm-8">
                        <div class="mx-3 my-2">
                            <ul class="breadcrumb ">
                                ...
                                <li class="breadcrumb-item">Teacher Add</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{-- @if ($errors->any())
                                <div class="d-flex justify-content-center">
                                    <div class="alert alert-warning col-md-12" role="alert">
                                        <div class="d-flex">
                                            <div class="me-3">
                                                <span class="mdi mdi-alert-circle-outline" style="font-size:21px;"></span>
                                            </div>
                                            <div class="w-100">
                                                <span style="font-size: 15px;">
                            ...
                            <form action="{{ route('add.teacherstore') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <!-- First Name -->
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="{{ old('registration_date') }}"
                                ...
                                <div class="row mt-3">
                                    <div class="col-auto d-flex justify-content-start">
                                        <button type="submit" name="product-submit"
                                            class="btn btn-primary btn-fill pull-right">Add Teacher</button>
